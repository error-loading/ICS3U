...
curNum = 1    # this counter is used to display what currency number we are on, not really neccessary
...
# this loops keeps going until user inputs a valid currency
